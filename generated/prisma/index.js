...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\l2_web_dev\\mission_07\\Prisma-orm\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\l2_web_dev\\mission_07\\Prisma-orm\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:10776@localhost:5432/prisma_orm?schema=public"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Post {\n  id        Int      @id @default(autoincrement())\n  title     String\n  content   String\n  published Boolean  @default(false)\n  author    String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  authorId  Int?\n\n  @@map(\"posts\")\n}\n",
  "inlineSchemaHash": "45c1cf8edec0970ea411da56553a187ca109df837c4dc2b65ccd83d31d1d44ad",
  "copyEngine": true
}
